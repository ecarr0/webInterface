...
public class Interface extends JFrame {
	...
	public final static String TEST_VIEW = "TEST_VIEW";
	public final static String ADMIN_VIEW = "ADMIN_VIEW";
	...
	public final static int TEST_VIEW_INDEX = 3;
	public final static int ADMIN_VIEW_INDEX = 4;
...
//			manager.db.deleteTable();
		...
		views.add(new TestView(manager), TEST_VIEW);
